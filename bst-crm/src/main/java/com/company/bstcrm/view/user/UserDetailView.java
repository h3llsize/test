package com.company.bstcrm.view.user;

import com.company.bstcrm.app.AvitoRequestService;
...
public class UserDetailView extends StandardDetailView<User> {
    ...
    @Subscribe(id = "sendToAvito", subject = "clickListener")
    public void onSendToAvitoClick(final ClickEvent<JmixButton> event) {
        avitoRequestService.addEmployee(getEditedEntity());
    }
